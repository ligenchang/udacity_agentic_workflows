    ...
    def evaluate(self, initial_prompt):
        ...
        for i in range(self.max_interactions): # TODO: 2 - Set loop to iterate up to the maximum number of interactions:
            ...
            response = client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": f"You are {self.persona}, a rigorous evaluator."},
            ...
            if evaluation.lower().startswith("yes"):
                ...
                response = client.chat.completions.create(
                    ...
                    messages=[
                    {"role": "system", "content": f"You are {self.persona}, a helpful teacher."},
...
class ActionPlanningAgent:
    ...
    def extract_steps_from_prompt(self, prompt):
        ...
        steps = [step.strip() for step in raw_steps if step.strip() and not step.strip().lower().startswith("note:")]
